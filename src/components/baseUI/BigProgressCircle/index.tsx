...
import styles from './BigProgressCircle.module.scss';

type ProgressCircleType = {
  percent: number;
};

const BigProgressCircle: React.FC<ProgressCircleType> = ({ percent }) => {
  const bar = {
    low: '#db2360',
    medium: '#d2d531',
    high: '#21d07a',
  ...
  return (
    <div className={styles.circle}>
      <svg width="60px" height="60px" viewBox="0 0 100 100" style={{ transform: 'rotate(-90deg)' }}>
        <circle
          cx="52.5"
          cy="52.5"
          r="50"
...
export default BigProgressCircle;
